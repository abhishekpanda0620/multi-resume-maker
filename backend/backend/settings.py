...
SECRET_KEY = 'django-insecure-w_w%8)$8)q2r$4z8pr+e9lo$la988s(rne@pu$dv4%d0xhhql)'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=20000),  # Default: 5 minutes
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'logs', 'resume_customizer.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
